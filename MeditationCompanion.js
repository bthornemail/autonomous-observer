...
const MeditationCompanion = () => {
    ...
    return (<div className="meditation-companion">
      ...
      {!session.isActive ? (<div>
          <div style={{ margin: '2rem 0' }}>
            ...
            <input type="range" min="1" max="30" value={session.duration} onChange={(e) => setSession(prev => ({
                ...prev,
          ...
          <div style={{ margin: '2rem 0' }}>
            ...
            <select value={session.pattern} onChange={(e) => setSession(prev => ({
                ...prev,
          ...
          <div style={{ margin: '2rem 0' }}>
            ...
            <select value={session.breathing} onChange={(e) => setSession(prev => ({
                ...prev,
          ...
          <div style={{ margin: '2rem 0' }}>
            ...
            {session.breathing === 'phi_breathing' && (<div style={{ fontSize: '0.9rem', color: '#cccccc', marginTop: '1rem' }}>
          ...
          <button className="sacred-button" onClick={stopMeditation} style={{ background: 'rgba(255,0,0,0.7)' }}>
            ⏹️ End Meditation
          </button>
        </div>)}
