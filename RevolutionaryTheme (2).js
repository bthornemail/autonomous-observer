...
export const RevolutionaryTheme = ({ children }) => {
    ...
    return (_jsx(ThemeContext.Provider, { value: revolutionaryTheme, children: _jsxs("div", { className: "revolutionary-theme", children: [children, _jsx("style", { children: `
          .revolutionary-theme {
