...
function App() {
    ...
    return (<div className="app">
      ...
      <nav className="app-nav">
        <button className={activeTab === 'harmony' ? 'active' : ''} onClick={() => setActiveTab('harmony')} title="Calculate your personal harmony score using sacred mathematics">
          📐 Harmony Calculator
        </button>
        <button className={activeTab === 'visualizer' ? 'active' : ''} onClick={() => setActiveTab('visualizer')} title="Explore interactive sacred geometry patterns">
          ✨ Sacred Geometry
        </button>
        <button className={activeTab === 'meditation' ? 'active' : ''} onClick={() => setActiveTab('meditation')} title="Guided meditation with phi breathing and sacred patterns">
          🧘 Meditation
        </button>
      </nav>
